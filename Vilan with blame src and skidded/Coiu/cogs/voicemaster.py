...
class vmbuttons(discord.ui.View):
         ...
         async with interaction.client.db.cursor() as cursor: 
          ...
          if check is not None:     
             ...
             if interaction.user.voice is None:
                e = discord.Embed(color=Colors.yellow, description=f"{Emojis.Emojis.warninging} {interaction.user.mention}: You are not in your voice channel")
             ...
             if che is None:
                embe = discord.Embed(color=Colors.yellow, description=f"{Emojis.Emojis.warninging} {interaction.user.mention}: you don't own this voice channel")
        ...
        async with interaction.client.db.cursor() as cursor: 
          ...
          if check is not None:     
             ...
             if che is None:
              ...
              if limit == 99:
                emb = discord.Embed(color=Colors.yellow, description=f"{Emojis.Emojis.warninging} {interaction.user.mention}: I can't increase the limit for <#{interaction.user.voice.channel.id}>")
                await interaction.response.send_message(embed=emb, view=None, ephemeral=True)
                return
        ...
        async with interaction.client.db.cursor() as cursor: 
          ...
          if check is not None:     
             ...
             if che is None:
              ...
              limit = interaction.user.voice.channel.user_limit
              if limit == 0:
                emb = discord.Embed(color=Colors.yellow, description=f"{Emojis.Emojis.warninging} {interaction.user.mention} i can't decrease the limit for <#{interaction.user.voice.channel.id}>")
                await interaction.response.send_message(embed=emb, view=None, ephemeral=True)
                return
          ...
          if check is not None:     
             ...
             if che is not None:
                ...
                if member in interaction.user.voice.channel.members:
                    embed = discord.Embed(color=Colors.yellow, description=f"{Emojis.Emojis.warninging} {interaction.user.mention}: the owner is still in the voice channel")
    ...
    @discord.ui.button(label="", emoji="<:icons_delete:1045973161738522644>", style=discord.ButtonStyle.gray, custom_id="persistent_view:delete")
   ...
   async def voicemaster(self, ctx: commands.Context, option=None):
    ...
    if option == None:
     ...
     async with self.bot.db.cursor() as cursor: 
      ...
      check = await cursor.fetchone() 
      if check is not None:
            em = discord.Embed(color=Colors.yellow, description=f"{Emojis.Emojis.warninging} {ctx.author.mention}: voice master is already set")
        ...
        em = discord.Embed(color=0x2f3136, title="VoiceMaster", description="click the buttons below to control the voice channel")
        em.set_thumbnail(url=self.bot.user.avatar.url)
        em.add_field(name="Button Usage", value="<:icons_locked:986219156821131304> - [`lock`](https://discord.gg/antiwizz) the voice channel\n<:icons_unlock:986219160369508393> - [`unlock`](https://discord.gg/antiwizz) the voice channel\n<:icons_on:986220176829726780> - [`reveal`](https://discord.gg/antiwizz) the voice channel\n<:icons_off:986220179983831061> - [`hide`](https://discord.gg/antiwizz) the voice channel\n<:icons_richpresence:986220183519657985> - [`rename`](https://discord.gg/antiwizz) the voice channel\n<:icons_increase:1021037401059119156> - [`increase`](https://discord.gg/antiwizz) the user limit\n<:icons_decrease:1021037305311535196> - [`decrease`](https://discord.gg/antiwizz) the user limit\n<:icons_owner:986220186988326933> - [`claim`](https://discord.gg/antiwizz) the voice channel\n<:icons_todolist:986252960570961943> - [`info`](https://discord.gg/antiwizz) of the voice channel\n<:icons_delete:1045973161738522644> - [`delete`](https://discord.gg/antiwizz) a voice channel")    
      ...
      async with self.bot.db.cursor() as cursor: 
         ...
         check = await cursor.fetchone() 
         if check is None:
            em = discord.Embed(color=Colors.yellow, description=f"{Emojis.Emojis.warninging} {ctx.author.mention}: voice master module isn't set")
            await ctx.reply(embed=em, mention_author=False)
            return
